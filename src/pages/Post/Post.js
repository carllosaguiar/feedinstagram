...
class Post extends Component {
    ...
    if (this.props.liked) {
      ...
      return (
        <TouchableOpacity onPress={this.like.bind(this)}>
          <View>
            <SimpleLineIcons name="heart" size={30} style={{ marginRight: 5 }} color="black"/>
          </View>
        </TouchableOpacity>
      );
    }
  ...
  renderViewMessages = () => {
    if (!this.state.viewMessages) {
      return (
        <TouchableOpacity onPress={this.viewMessages.bind(this)} style={{ marginLeft: 15 }}>
          <View>
  ...
  viewMessages = () => {
    this.setState({
      viewMessages: !this.state.viewMessages
    });
  };
  ...
  render() {
    return (
      <View>
        ...
        <View style={{ alignContent: 'center' }}>{this.renderViewMessages()}</View>
